...
export default function FeatureDatatable(props) {
    ...
    const {isLoading,data} = useQuery({queryKey:['features'],queryFn:async ()=>getData({token,url:`${BASE_URL}api/v1/feature/`})})
    ...
    const saveProduct = () => {
        ...
        const data = {...product,token,url:`${BASE_URL}api/v1/feature/`}
    ...
    const updateProduct  = ()=>{
        const url = `${BASE_URL}api/v1/feature/${product.id}/`
    ...
    const deleteProduct = () => {
        const data = {id:product.id,token,url:`${BASE_URL}api/v1/feature/${product.id}/`}
    ...
    const header = (
        <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
            <h4 className="m-0">Manage Features</h4>
